...
const facilityStats = [
  { label: "Production Area", value: "6,000", unit: "sq. ft." },
...
const machines = [
  {
    ...
    name: "Wire Cutting & Automatic Crimping Machine",
    category: "Wire Processing",
    desc: "Wire cutting and automatic crimping machine.",
    specs: ["Quantity: 1"],
  },
  {
    ...
    category: "Wire Processing",
    desc: "Wire cutting machine.",
    specs: [],
  },
  {
    image: "/images/manufacturing/machine-3.jpeg",
    name: "Sleeve Cutting Machine",
    category: "Sleeve Processing",
    desc: "Sleeve cutting machine.",
    specs: [],
  },
  {
    image: "/images/manufacturing/machine-4.jpeg",
    name: "Sleeve Shrinking Tunnel/Machine",
    category: "Sleeve Processing",
    desc: "Sleeve shrinking tunnel or machine.",
    specs: [],
  },
  {
    image: "/images/manufacturing/machine-5.jpeg",
    name: "Wire Cutting, Dipping, Crimping & Twisting Machine",
    category: "Wire Processing",
    desc: "Wire cutting, dipping, crimping and twisting machine.",
    specs: [],
  },
  {
    image: "/images/manufacturing/machine-6.jpeg",
    name: "Manual Crimping Machines",
    category: "Crimping",
    desc: "Manual crimping machines.",
    specs: ["Quantity: 5"],
  },
  {
    image: "/images/manufacturing/machine-7.jpeg",
    name: "Automatic Crimping Machines",
    category: "Crimping",
    desc: "Automatic crimping machines.",
    specs: ["Quantity: 2"],
  },
  {
    image: "/images/manufacturing/machine-8.jpeg",
    name: "Vertical Moulding Machines",
    category: "Moulding",
    desc: "Vertical moulding machines.",
    specs: ["Quantity: 3"],
  },
];

const pcbLineMachines = [
  {
    image: "/images/manufacturing/pcb-diode-lead-cutting.jpg",
    name: "Automatic Diode Lead Cutting Machine",
    category: "PCB Line",
    desc: "Automatic diode lead cutting machine.",
    specs: [],
  },
  {
    image: "/images/manufacturing/pcb-loose-radial-cutting.jpg",
    name: "Loose Radial Cutting Machine",
    category: "PCB Line",
    desc: "Loose radial cutting machine.",
    specs: [],
  },
  {
    image: "/images/manufacturing/pcb-manual-insertion-line.jpg",
    name: "Manual Components Insertion Line",
    category: "PCB Line",
    desc: "Manual components insertion line.",
    specs: [],
  },
];
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-12">
          <motion.div {...fadeInUp} className="max-w-2xl mb-16">
            ...
            <p className="text-slate-500 text-base leading-relaxed">
              Dedicated PCB line machinery for component preparation and manual
              insertion assembly.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {pcbLineMachines.map((m, i) => (
              <MachineCard key={i} {...m} index={i} />
            ))}
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="hidden absolute inset-0 items-center justify-center text-slate-600">
