...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/api/contact`, formData, { timeout: 45000 });
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl font-black text-slate-900 mb-6 break-words">Let's Discuss Your <br/><span className="text-cyan-500">Requirements.</span></h1>
          ...
          >
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {isSubmitting ? (isSlow ? "Still connecting…" : "Transmitting...") : "Send to Engineering Team"} <Send size={16} />
              </button>
              {isSubmitting && isSlow && (
